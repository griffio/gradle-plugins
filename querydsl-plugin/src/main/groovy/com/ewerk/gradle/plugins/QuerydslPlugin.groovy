...
class QuerydslPlugin implements Plugin<Project> {
    ...
    void apply(final Project project) {
        ...
        project.afterEvaluate {
            ...
            querydslAnnotationProcessorsTask(project)
    ...
    private static void querydslAnnotationProcessorsTask(Project project) {
        project.task(type: QuerydslAnnotationProcessor, "queryDslAnnotationProcessing")
        project.tasks.queryDslAnnotationProcessing.dependsOn project.tasks.initQuerydslSourcesDir
        project.tasks.compileJava.dependsOn project.tasks.queryDslAnnotationProcessing
    }
